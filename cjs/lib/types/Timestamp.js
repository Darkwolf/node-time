...
Timestamp.from = value => new Timestamp(value)
Timestamp.fromMilliseconds = milliseconds => new Timestamp(milliseconds)
Timestamp.fromMillis = millis => Timestamp.fromMilliseconds(millis)
Timestamp.fromSeconds = seconds => new Timestamp(Duration.inSeconds(seconds))
